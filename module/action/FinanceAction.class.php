...
class FinanceAction extends BaseAction {
	/*
	 * @param $actionPath @return AdminAction
	 */
...
// 发票跳转
	...
	function salCaiwuImport() {
		...
		/*
		 * $this->objDao=new SalaryDao(); $salaryTimeList=$this->objDao->searhSalaryTimeList(); $this->objForm->setFormData("salaryTimeList",$salaryTimeList);
		 */
	}
