...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div id="right">
            ...
            <div class="form">
            <form id="form1" method="post" action="index.php?action=Employ&mode=addEmploy">
               ...
               <div class="input">
                       ...
                       <tr>
                           ...
                           <td class="td_right" nowrap>
                               <input type="text" id="company" name="company" maxlength="255" style="width:150px;float:left" value=""/>
                           </td>
                           <td class="td_right">
                       ...
                       <tr>
                           ...
                           <td class="td_right" nowrap>
                               <input type="text" id="e_type" name="e_type" maxlength="255" style="width:150px;float:left" value=""/>
                           </td>
                           <td class="td_right">
