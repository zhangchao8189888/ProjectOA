...
<title>年终奖查询</title>
 ...
 Ext.require([
          ...
          Ext.onReady(function(){
               ...
               //   selType: 'checkboxmodel',
                  ...
                  tbar : [
                      ...
                      '年终奖月份', {
                          ...
                          name: 'salTime',
                          onTriggerClick : function(src) {
                              checkCompanyStore.removeAll();
                              checkCompanyStore.load( {
                                  params : {
              ...
              checkCompanyStore.on("beforeload",function(){

                  Ext.apply(checkCompanyStore.proxy.extraParams, {Key:Ext.getCmp("comname").getValue()});
