...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body>
    ...
    <div id="right">
        <!--导航栏-->
        <div class="navigate">员工列表查询 <input type="button" value=" 返回客服首页 " id="btn_ok" class="btn_submit" onclick="returnList();"/>
                 </div>
        <div class="manage">
        <font color="red"></font>
        </div>
     ...
     <form enctype="multipart/form-data" id="iform" action="" method="post"> 
			...
			<input type="hidden" id="modeType" name="modeType" value="service"/>
...
<?php }?>
        ...
        <div class="submit">
                   <input type="button" value=" 添加客服操作公司  " id="btn_ok" class="btn_submit" onClick="add();"/>
               </div>
