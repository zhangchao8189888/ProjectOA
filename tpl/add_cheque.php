...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div id="right">
            ...
            <div class="form">
            <form id="form1" method="post" action="index.php?action=SalaryBill&mode=addCheque">
               <div id="span_msg"><font color="red"><?php if($errorMsg)echo $errorMsg?></font>
			<font color="green"><?php if($succ)echo $succ?></font></div>
               <div class="input">
               		<table>
               		 <tr>
                           <td class="td_left" id="index"><label>支票类型：</label></td>
                           <td class="td_right" nowrap>
                                <select  name="chequeType" id="chequeType" >
                                <option value="2">支票</option>
                                <option value="3">到账支票</option>
			</select></td>
                           <td class="td_right">
                               <div id="e_noTip"></div>
                           </td>
			...
			<?php  if($comList){
                ...
                <?php }?>
                       ...
                       <tr>
                           <td class="td_left" id="index"><label>支票/到账支票  金额:</label></td>
                           <td class="td_right" nowrap>
