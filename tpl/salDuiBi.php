    ...
    <script language="javascript" type="text/javascript">
        ...
        function b(type) {
            if (type == 'emp') {
                ...
                $("#iform").attr("action", "index.php?action=Salary&mode=perZiliaoDuibi");
                $("#iform").submit();
            } else if (type == 'com') {
                ...
                $("#iform_com").attr("action", "index.php?action=Salary&mode=salPerDuibi");
                $("#iform_com").submit();
            } else if (type == 'jishu') {
                ...
                $("#iform_jishu").attr("action", "index.php?action=Salary&mode=jishuDuibi");
                $("#iform_jishu").submit();
            }
        }
    </script>
...
<div id="main" style="min-width:960px">
    ...
    <div id="right">
        ...
        <!--功能项-->
        <div class="manage">
            <form enctype="multipart/form-data" id="iform" action="index.php?action=Salary&mode=perZiliaoDuibi" method="post">
        ...
        <form enctype="multipart/form-data" id="iform_com" action="index.php?action=Salary&mode=sumSalary" method="post">
            <div class="manage">
                ...
                姓名：<input type="text" name="name_com" value="" size="1"/>
                ...
                个人公积金：<input type="text" name="pergongjijin_com" value="9" size="1"/>
            </div>
            <div class="manage">
        ...
        <div class="manage">
            <form enctype="multipart/form-data" id="iform_jishu" action="index.php?action=Salary&mode=sumSalary"
                  method="post">
                ...
                姓名：<input type="text" name="name_jishu" value="" size="1"/>
