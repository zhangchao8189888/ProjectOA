    ...
    var serviceManage = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
                ...
                dataIndex: 'company_name', width: 180},
            {
                ...
                renderer: function (val, cellmeta, record) {
                    if (val == 0) {
                        return '<a href="#" title="做工资" onclick=makeSal(' + record.data['companyId'] + ',"' + record.data['salDate'] + '","first")><span style="color: red"> 未做工资 </span></a>' ;
//                        return '<a href="#" title="做工资" onclick=makeSal(' + record.data['companyId'] + ',"' + record.data['salDate'] + '","first")><font color="red">未做工资</font></a>';
            ...
            },
            {
                ...
                renderer: function (val, cellmeta, record) {
                    if (val == 0) {
                        return '<a href="#" title="做二次工资" onclick=makeSal(' + record.data['companyId'] + ',"' + record.data['salDate'] + '","second")><span style="color: red"> 无 </span></a>';
                    } else if (val > 0) {
