...
Ext.onReady(function(){
        ...
        tbar : [
            ...
            '公司名称查询', {
                ...
                onTriggerClick : function(src) {
                    salaryComListstore.removeAll();
                    salaryComListstore.load( {
                        params : {
    ...
    salaryComListstore.on("beforeload",function(){

        Ext.apply(salaryComListstore.proxy.extraParams, {Key:Ext.getCmp("comname").getValue(),companyName:Ext.getCmp("comname").getValue()});
