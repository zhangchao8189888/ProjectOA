...
//      selType: 'checkboxmodel',
     ...
     columns: [
               ...
               {text: "未知", flex: 200, dataIndex: 'pact_start_date', sortable: true},
               {text: "审核状态", flex: 200, dataIndex: 'pact_over_date', sortable: true},
               {text: "审核状态", flex: 200, dataIndex: 'service_fee_state', sortable: true},
               {text: "审核状态", flex: 200, dataIndex: 'service_fee_value', sortable: true},
               {text: "审核状态", flex: 200, dataIndex: 'can_bao_state', sortable: true},
               {text: "审核状态", flex: 200, dataIndex: 'can_bao_value', sortable: true},
               {text: "审核状态", flex: 200, dataIndex: 'companyEmail', sortable: true},
               {text: "审核状态", flex: 200, dataIndex: 'remarks', sortable: true},              
               ],
       height:700,
       width:1000,
       x:0,
       ...
       stripeRows: false
              ...
              checkcompany.on("beforeload",function(){

                  Ext.apply(checkcompany.proxy.extraParams, {Key:Ext.getCmp("comname").getValue()});
              ...
              var ccompany = Ext.create('Ext.data.Store', {
                  model: salTimeList,
                  proxy: {
                      type: 'ajax',
                      url : 'index.php?action=Finance&mode=searchcompanyListJosn'
                  }
              });
  //通过ajax获取表头以及表格数据
