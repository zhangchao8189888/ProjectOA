...
document.writeln('             onfocus="this.blur()" style="font-size: 10px; height: 20px"><input Author=meizz title="向前翻 1 月" type=button ');
document.writeln('             value="<<" onclick="meizzPrevM()" onfocus="this.blur()" style="font-size: 10px; height: 20px"></td><td ');
document.writeln('             Author=meizz align=center><input Author=meizz type=button value=" Today " onclick="meizzToday()" ');
document.writeln('             onfocus="this.blur()" title="现在的年月" style="font-size: 10px; height: 20px"></td><td ');
document.writeln('             Author=meizz align=right><input Author=meizz type=button value=">>" onclick="meizzNextM()" ');
document.writeln('             onfocus="this.blur()" title="往后翻 1 月" style="font-size: 10px; height: 20px"><input ');
document.writeln('             Author=meizz type=button value=" >" title="往后翻 1 年" onclick="meizzNextY()"');
document.writeln('             onfocus="this.blur()" style="font-size: 10px; height: 20px"></td>');
